...
export default function LoginPage() {
  ...
  if (!ready) {
    return <div className="loading-screen"><span className="spinner" /><p>계정 정보를 확인하고 있습니다.</p></div>;
  }
    ...
    <main className="login-page">
      <section className="login-brand-panel">
        ...
        <div className="login-copy">
          ...
          <h1>성장하는 시간을<br />관리의 빈틈 없이</h1>
          <p>업무 기록부터 과제, 평가, 일정까지. 운영에 필요한 일을 하나의 공간에서 관리합니다.</p>
          <div className="login-features">
            <span><CheckCircle2 size={17} /> 역할에 맞춘 접근 권한</span>
            <span><CheckCircle2 size={17} /> 업무 현황의 빠른 확인</span>
            <span><CheckCircle2 size={17} /> 기록과 피드백의 체계적 관리</span>
          </div>
        </div>
